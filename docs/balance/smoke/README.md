...
exactly like drift. The current baseline (`baseline-r2c-explorer-remit.json`) used
`--milestone-days 21,29,30,41,60,120` over all eight policies including `trader-degraded`.
