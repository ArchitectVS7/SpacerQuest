...
const PIRATES: NpcSeedData[] = [
  { type: 'PIRATE' as NpcType, shipClass: 'Maligna Bat', commander: 'K)(akj', shipName: 'K1++++', homeSystem: 'Pollux-7', alliance: 'ASTRO_LEAGUE' as AllianceType, rosterIndex: 1, creditValue: 70, fuelCapacity: 500, weaponStrength: 14, weaponCondition: 9, shieldStrength: 16, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 20, driveCondition: 9, hullStrength: 16 },
  { type: 'PIRATE' as NpcType, shipClass: 'Maligna Cat', commander: 'K)(ych', shipName: 'K2@@@@', homeSystem: 'Denebola-5', alliance: 'SPACE_DRAGONS' as AllianceType, rosterIndex: 2, creditValue: 80, fuelCapacity: 500, weaponStrength: 16, weaponCondition: 9, shieldStrength: 18, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 17, driveCondition: 9, hullStrength: 17 },
  { type: 'PIRATE' as NpcType, shipClass: 'Maligna Rat', commander: 'K)(sfy', shipName: 'K3####', homeSystem: 'Denebola-5', alliance: 'NONE' as AllianceType, rosterIndex: 3, creditValue: 90, fuelCapacity: 500, weaponStrength: 18, weaponCondition: 9, shieldStrength: 20, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 18, driveCondition: 9, hullStrength: 18 },
  { type: 'PIRATE' as NpcType, shipClass: 'Maligna Tat', commander: 'K)(sdf', shipName: 'K4$$$$', homeSystem: 'Aldebaran-1', alliance: 'NONE' as AllianceType, rosterIndex: 4, creditValue: 110, fuelCapacity: 500, weaponStrength: 22, weaponCondition: 9, shieldStrength: 22, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 19, driveCondition: 9, hullStrength: 19 },
  { type: 'PIRATE' as NpcType, shipClass: 'Maligna Vat', commander: 'K)(ssf', shipName: 'K5%%%%', homeSystem: 'Altair-3', alliance: 'NONE' as AllianceType, rosterIndex: 5, creditValue: 120, fuelCapacity: 500, weaponStrength: 24, weaponCondition: 9, shieldStrength: 24, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 20, driveCondition: 9, hullStrength: 20 },
  { type: 'PIRATE' as NpcType, shipClass: 'Maligna Wat', commander: 'K)(dfy', shipName: 'K6^^^^', homeSystem: 'Altair-3', alliance: 'REBEL_ALLIANCE' as AllianceType, rosterIndex: 6, creditValue: 130, fuelCapacity: 500, weaponStrength: 26, weaponCondition: 9, shieldStrength: 26, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 22, driveCondition: 9, hullStrength: 21 },
  { type: 'PIRATE' as NpcType, shipClass: 'Maligna Xat', commander: 'K)(dsh', shipName: 'K7&&&&', homeSystem: 'Pollux-7', alliance: 'WARLORD_CONFED' as AllianceType, rosterIndex: 7, creditValue: 140, fuelCapacity: 500, weaponStrength: 28, weaponCondition: 9, shieldStrength: 28, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 24, driveCondition: 9, hullStrength: 20 },
  { type: 'PIRATE' as NpcType, shipClass: 'Maligna Yat', commander: 'K)(ech', shipName: 'K8****', homeSystem: 'Aldebaran-1', alliance: 'NONE' as AllianceType, rosterIndex: 8, creditValue: 150, fuelCapacity: 500, weaponStrength: 30, weaponCondition: 9, shieldStrength: 30, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 26, driveCondition: 9, hullStrength: 20 },
  { type: 'PIRATE' as NpcType, shipClass: 'Maligna Zat', commander: 'K)(chy', shipName: 'K9((((', homeSystem: 'Denebola-5', alliance: 'NONE' as AllianceType, rosterIndex: 9, creditValue: 160, fuelCapacity: 500, weaponStrength: 32, weaponCondition: 9, shieldStrength: 32, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 30, driveCondition: 9, hullStrength: 22 },
];
...
const PATROL: NpcSeedData[] = [
  { type: 'PATROL' as NpcType, shipClass: 'SLOOP', commander: 'Lt.Savage', shipName: 'SP1.Thor', homeSystem: 'Procyon-5', alliance: 'NONE' as AllianceType, rosterIndex: 1, creditValue: 80, fuelCapacity: 1000, weaponStrength: 16, weaponCondition: 9, shieldStrength: 15, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 20, driveCondition: 9, hullStrength: 16 },
  { type: 'PATROL' as NpcType, shipClass: 'CUTTER', commander: 'Cmdr.Strong', shipName: 'SP2.Hercules', homeSystem: 'Mira-9', alliance: 'NONE' as AllianceType, rosterIndex: 2, creditValue: 90, fuelCapacity: 1000, weaponStrength: 18, weaponCondition: 9, shieldStrength: 17, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 18, driveCondition: 9, hullStrength: 17 },
  { type: 'PATROL' as NpcType, shipClass: 'BARK', commander: 'Como.Brainerd', shipName: 'SP3.Fearless', homeSystem: 'Fomalhaut-2', alliance: 'NONE' as AllianceType, rosterIndex: 3, creditValue: 100, fuelCapacity: 1000, weaponStrength: 20, weaponCondition: 9, shieldStrength: 19, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 16, driveCondition: 9, hullStrength: 18 },
  { type: 'PATROL' as NpcType, shipClass: 'BRIGANTINE', commander: 'Capt.Brutus', shipName: 'SP4.Darkover', homeSystem: 'Procyon-5', alliance: 'NONE' as AllianceType, rosterIndex: 4, creditValue: 110, fuelCapacity: 1000, weaponStrength: 22, weaponCondition: 9, shieldStrength: 21, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 19, driveCondition: 9, hullStrength: 19 },
  { type: 'PATROL' as NpcType, shipClass: 'CORVETTE', commander: 'Capt.Armand', shipName: 'SP5.Courageous', homeSystem: 'Regulus-6', alliance: 'NONE' as AllianceType, rosterIndex: 5, creditValue: 120, fuelCapacity: 1000, weaponStrength: 24, weaponCondition: 9, shieldStrength: 23, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 20, driveCondition: 9, hullStrength: 20 },
  { type: 'PATROL' as NpcType, shipClass: 'DESTROYER', commander: 'Capt.Bouchet', shipName: 'SP6.Firedrake', homeSystem: 'Pollux-7', alliance: 'NONE' as AllianceType, rosterIndex: 6, creditValue: 130, fuelCapacity: 1000, weaponStrength: 26, weaponCondition: 9, shieldStrength: 25, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 22, driveCondition: 9, hullStrength: 21 },
  { type: 'PATROL' as NpcType, shipClass: 'CRUISER', commander: 'Capt.Brax', shipName: 'SP7.Victorious', homeSystem: 'Procyon-5', alliance: 'NONE' as AllianceType, rosterIndex: 7, creditValue: 140, fuelCapacity: 1000, weaponStrength: 28, weaponCondition: 9, shieldStrength: 27, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 24, driveCondition: 9, hullStrength: 20 },
  { type: 'PATROL' as NpcType, shipClass: 'FRIGATE', commander: 'Adm.Wong', shipName: 'SP8.Meritorious', homeSystem: 'Deneb-4', alliance: 'NONE' as AllianceType, rosterIndex: 8, creditValue: 160, fuelCapacity: 1000, weaponStrength: 32, weaponCondition: 9, shieldStrength: 29, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 26, driveCondition: 9, hullStrength: 20 },
  { type: 'PATROL' as NpcType, shipClass: 'BATTLESHIP', commander: 'Adm.Hutchins', shipName: 'SP9.Incredible', homeSystem: 'Aldebaran-1', alliance: 'NONE' as AllianceType, rosterIndex: 9, creditValue: 200, fuelCapacity: 1000, weaponStrength: 40, weaponCondition: 9, shieldStrength: 31, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 30, driveCondition: 9, hullStrength: 22 },
  { type: 'PATROL' as NpcType, shipClass: 'DEATHSTAR', commander: 'Adm.Bruiser', shipName: 'SPX.Inferno', homeSystem: 'Arcturus-6', alliance: 'NONE' as AllianceType, rosterIndex: 10, creditValue: 275, fuelCapacity: 1000, weaponStrength: 55, weaponCondition: 9, shieldStrength: 50, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 40, driveCondition: 9, hullStrength: 24 },
  { type: 'PATROL' as NpcType, shipClass: 'INFINITY', commander: 'Adm.Borgia', shipName: 'SPZ.Infinity', homeSystem: 'Altair-3', alliance: 'NONE' as AllianceType, rosterIndex: 11, creditValue: 325, fuelCapacity: 1000, weaponStrength: 65, weaponCondition: 9, shieldStrength: 60, shieldCondition: 9, hullCondition: 9, lifeSupportCond: 9, driveStrength: 50, driveCondition: 9, hullStrength: 30 },
];
...
async function main() {
  ...
  // GameConfig singleton (SP.EDIT3 sp.conf defaults)
  await prisma.gameConfig.upsert({
    where: { id: 'default' },
    create: { id: 'default' },
    update: {},
  });
  console.log('✅ GameConfig initialized with defaults\n');
