...
export async function buyPort(characterId, systemId) {
    ...
    if (!success)
        return { success: false, error: 'Not enough credits to buy port' };
...
export async function collectPortDividends(characterId, systemId) {
