...
import { RANK_HONORARIA, ALLIANCE_SYMBOLS, NAME_MIN_LENGTH, NAME_MAX_LENGTH, RESERVED_PREFIXES, } from './constants.js';
// ============================================================================
// CREDIT HANDLING
// ============================================================================
/**
 ...
 */
export function formatCredits(high, low) {
    if (high <= 0) {
        return low.toString();
    }
 ...
 */
export function addCredits(high, low, amount) {
    let newHigh = high;
 ...
 */
export function subtractCredits(high, low, amount) {
 ...
 */
export function getTotalCredits(high, low) {
 ...
 */
export function getHonorarium(rank) {
    return RANK_HONORARIA[rank] || 0;
}
/**
 ...
 */
export function getAllianceSymbol(alliance) {
    return ALLIANCE_SYMBOLS[alliance] || '';
}
/**
 * Append alliance symbol to name
 */
export function appendAllianceSymbol(name, alliance) {
 ...
 */
export function removeAllianceSymbol(name) {
    return name.replace(/[-+@&^]$/, '');
}
// ============================================================================
// NAME VALIDATION
 ...
 */
export function checkProbability(chance) {
 ...
 */
export function isDayDifferent(date1, date2 = new Date()) {
    if (!date1)
        return true;
 ...
 */
export function calculateComponentPower(strength, condition) {
    if (strength < 1 || condition < 1)
        return 0;
 ...
 */
export function calculateDamagePercent(condition) {
 ...
 */
export function conditionFromDamage(damagePercent) {
 ...
 */
export function centerString(str, length, char = ' ') {
 ...
 */
export function horizontalLine(char, length) {
    return char.repeat(length);
}
/**
 * Create box border
 */
export function createBoxBorder(width, char = '-') {
