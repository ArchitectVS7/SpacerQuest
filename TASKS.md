...
### T-1801 · Honest bond-intervention sim — `status: TODO` · `coder: opus` · `after: —`
...
### T-1802 · Post-flip encounter-damp assertion — `status: TODO` · `coder: opus` · `after: —`
...
### T-1803 · Action-driven fuel-capacity A/B — `status: TODO` · `coder: opus` · `after: —`
...
### T-1804 · Errata + Auto-Repair/life-support design call — `status: TODO` · `coder: opus` · `after: —`
